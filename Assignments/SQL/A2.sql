...
mobileNo VARCHAR(8),
studStream VARCHAR(10) CHECK (studStream in('science','commerce')), 
studCourseId INT,
...
SELECT * FROM employees ORDER BY firstName ASC LIMIT 6;
...
SELECT * FROM customers WHERE contactFirstName LIKE 'J%' AND state IS NOT NULL ORDER BY creditLimit DESC LIMIT 2;
