...
-- is Motocycles.
SELECT productCode,productName,productDescription,quantityInStock,productLine FROM products WHERE productLine = 'Motorcycles';
...
SELECT * FROM customers WHERE (creditLimit+2000) >=70000 AND (creditLimit+2000) <=85000;
