...
class IncDec extends React.Component {
  ...
  zero() {
    alert("Cannot display negative number");
    return 0;
  }
  handleCountAdd() {
  ...
  render() {
    let class_data =
      this.state.count <= 0 ? "badge badge-warning" : "badge badge-secondary";
    return (
      <div>
        <button className="btn btn-primary" onClick={this.handleCountAdd}>
          {" "}
          Increment
        </button>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button className="btn btn-primary" onClick={this.handleCountRem}>
          Decrement{" "}
        </button>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <br />
        <p>
          <b>
            Number of Items :
            <span style={this.frmtStylee} className={class_data}>
              {this.returnValue()}
            </span>
          </b>
        </p>
